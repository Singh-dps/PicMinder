...
const categorizePhotosAndSuggestActionsPrompt = ai.definePrompt({
  ...
  Suggest a list of up to 7 appropriate actions based on the photo's content. It is very important that you do NOT suggest any location-based actions like "Get Directions", "Take me to Location", or actions like "Scan QR Code".
