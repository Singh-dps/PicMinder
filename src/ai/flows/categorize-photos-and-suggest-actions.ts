...
const categorizePhotosAndSuggestActionsPrompt = ai.definePrompt({
  ...
  Suggest a list of up to 7 appropriate actions based on the photo's content. Do NOT suggest any location-based actions like "Get Directions" or "Take me to Location".
